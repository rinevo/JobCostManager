...
if (isset($_POST['post_type'])) {
	...
	switch ($_POST['post_type']) {
		case 'SET_SIME':
			...
			$ret = $edit->setIni_data(INI_KINTAI_SIME1, $sime1, $select_uid);
			if ($ret) {
				$ret = $edit->setIni_data(INI_KINTAI_SIME2, $sime2, $select_uid);
			}
		...
		case 'GET_TOTAL':
			...
			$edit = new CjCommonSQL($dbopts);
			$edit->setDefSime(INI_KINTAI_SIME1, INI_KINTAI_SIME2);

			$list = $edit->getTotal($select_uid, $select_uid, $date);
